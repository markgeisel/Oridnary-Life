...
x=((oDungeon3.roomList[| 9].x1+oDungeon3.roomList[| 9].x2+1)/2)*32
y= ((oDungeon3.roomList[| 9].y1+oDungeon3.roomList[| 9].y2+1)/2)*32
...
x=((oDungeon.roomList[| 9].x1+oDungeon.roomList[| 9].x2+1)/2)*32
y= ((oDungeon.roomList[| 9].y1+oDungeon.roomList[| 9].y2+1)/2)*32
...
if instance_exists(oDungeon) {
if oDungeon.count =2 &&oDungeon.roomList[| (ds_list_size(oDungeon.roomList) -10)]&&oDungeon.roomList[|8].c=3{
