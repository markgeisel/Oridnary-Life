...
if  (dungeon[# roomList[|n].x1,  roomList[|n].y1]-1 )==0  && (dungeon[# roomList[|n].x1-1,  roomList[|n].y1] )==0 {
 ...
 tilemap_set(layer_tilemap_get_id(layer_get_id("cull")),12,roomList[|n].x1, roomList[|n].y1)
}
...
tilemap_set(layer_tilemap_get_id(layer_get_id("cull")),11,roomList[|n].x1+9, roomList[|n].y1)}
