...
x=((oDungeon3.roomList[| 6].x1+oDungeon3.roomList[| 6].x2+1)/2)*32
y= ((oDungeon3.roomList[| 6].y1+oDungeon3.roomList[| 6].y2+1)/2)*32
...
x=((oDungeon.roomList[| 6].x1+oDungeon.roomList[| 6].x2+1)/2)*32
y= ((oDungeon.roomList[| 6].y1+oDungeon.roomList[| 6].y2+1)/2)*32
